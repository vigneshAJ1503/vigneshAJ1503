...
### What I'm doing?
- Designing and building **IAM systems** (authentication, authorization, RBAC, policy engines)
- Working on **high-scale backend systems** with strict latency requirements
- Building **Kafka-based platforms** and cloud-native services
...
- Observability & reliability-focused development
